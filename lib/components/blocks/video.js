...
var VideoBlock = function (_React$Component) {
  ...
  function VideoBlock() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = VideoBlock.__proto__ || Object.getPrototypeOf(VideoBlock)).call.apply(_ref, [this].concat(args))), _this), _this.focusBlock = function () {
      ...
      if (src !== null) {
        ...
        return _react2.default.createElement(
          ...
          _react2.default.createElement(
            'div',
            { className: 'md-block-video-inner-container', onClick: this.focusBlock },
            _react2.default.createElement('video', { width: '400', controls: true, src: data.src })
          ),
          _react2.default.createElement(
            'figcaption',
            extraProps,
